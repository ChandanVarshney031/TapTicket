    ...
    return (
        <div className="container animate-fade-in" style={{ paddingTop: '2rem', paddingBottom: '5rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '4rem' }}>
                ...
                {/* Details */}
                <div>
                    <h1 style={{ fontSize: '4rem', fontWeight: 800, marginBottom: '1rem' }}>{movie.title}</h1>
                    
                    <div style={{ display: 'flex', gap: '2rem', marginBottom: '2rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--accent)' }}>
                            <Star size={20} fill="var(--accent)" />
                            <span style={{ fontSize: '1.2rem', fontWeight: 600 }}>{movie.rating} Rating</span>
                        </div>
                    ...
                    <div style={{ marginBottom: '3rem' }}>
                        <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem' }}>Synopsis</h3>
                        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', lineHeight: '1.8' }}>{movie.description}</p>
                    </div>

                    <div style={{ marginBottom: '3rem' }}>
                        <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem' }}>Cast</h3>
                    ...
                    <div>
                        <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem' }}>Trailer</h3>
